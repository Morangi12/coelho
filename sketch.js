...
function setup() {
    ecel= /Android|iPhone|iPad/i.test(navigator.userAgent)
    ...
    b2.position(width / 5, height / 5);
    b2.size(50, 50);
    b2.mouseClicked(soltar2);

    b2 = createImg("cut_btn.png");
    b2.position(width / 3, height / 3);
    b2.size(50, 50);
    b2.mouseClicked(soltar3);
    ...
    corda2 = new Rope(7, { x: width / 5, y: height / 5 });
